// ignore_for_file: deprecated_member_use, file_names, prefer_is_empty

import 'package:chatbot_app_project/chatBot_project/learning_module/link_page.dart';
import 'package:chatbot_app_project/chatBot_project/learning_module/timeLine_event.dart';
import 'package:chatbot_app_project/chatBot_project/learning_module/video.dart';
...
class _TimelineWidgetState extends State<TimelineWidget>
  ...
  Widget _buildTimelineItem(
      TimelineEvent event, int index, double lineProgress) {
      ...
      child: Row(
        ...
        children: [
          TextButton.icon(
            onPressed: () {
              String gettitle = '';
              if (widget.domain.split(' ').length == 1) {
                setState(() {
                  gettitle = widget.domain.split(' ')[0];
                });
              } else {
                setState(() {
                  gettitle =
                      widget.domain.split(' ')[0] + widget.domain.split(' ')[1];
                });
              }
              print(gettitle);
              Navigator.push(
                ...
                MaterialPageRoute(
                  builder: (context) => VideoPlayerScreen(
                      assetPath: 'assets/videos/${gettitle.toLowerCase()}.mp4'),
                ),
              );
            },
          ...
          FilledButton.icon(
            onPressed: () {
              ...
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => DomainViewScreen(
                    domain: gettitle,
                  ),
                ),
              );
