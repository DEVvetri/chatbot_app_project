                      ...
                      builder: (
                        ...
                        return ListView.separated(
                            itemBuilder: (context, index) {
                              ...
                              bool isadmin = details[itemDetailList[index]]
                                  [feildValueadmin];
                              bool isread = details[itemDetailList[index]]
                                  [feildValueread];
                              return Padding(
                  ...
                  onTap: () {
                    showDialog(
                      ...
                      builder: (context) => AlertDialog(
                        ...
                        content: Text('Sure to Exit From ${widget.groupName}'),
                        actions: [
                          OutlinedButton(
                            onPressed: () {
                              Get.back();
                    ...
                    onTap: () {
                      showDialog(
                        ...
                        builder: (context) => AlertDialog(
                          ...
                          content: Text('Sure to delete ${widget.groupName}'),
                          actions: [
                            OutlinedButton(
                              onPressed: () {
                                Get.back();
